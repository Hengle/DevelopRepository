...
public class BasicBehaviour : MonoBehaviour
{
    ...
    void OnDrawGizmos()
    {
        ...
        Gizmos.DrawRay(this.transform.position + Vector3.up * 2 * colExtents.x, Vector3.down);

        Gizmos.DrawWireSphere(transform.position + Vector3.up * 2 * colExtents.x, colExtents.x);
    ...
    //    Gizmos.DrawWireSphere(transform.position, colExtents.x + 0.2f);
    //}
}
