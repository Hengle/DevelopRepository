...
public class AppLovinIntegrationManagerWindow : EditorWindow
{
    ...
    private void DrawQualityServiceSettings()
    {
        ...
        using (new EditorGUILayout.VerticalScope("box"))
        {
            ...
            AppLovinSettings.Instance.SdkKey = DrawTextField("AppLovin SDK Key", AppLovinSettings.Instance.SdkKey, sdkKeyTextFieldWidthOption);
            GUILayout.BeginHorizontal();
            GUILayout.Space(4);
    ...
    private string DrawTextField(string fieldTitle, string text, GUILayoutOption textFieldWidthOption = null)
    {
        GUILayout.BeginHorizontal();
        GUILayout.Space(4);
    ...
    private void CalculateFieldWidth()
    {
        ...
        var availableTextFieldWidth = currentWidth - networkLabelWidth - 45; // NOTE: Magic number alert. This is the sum of all the spacing the fields and other UI elements.
