...
namespace SDKManager {
    public class AppLovinManager : MonoBehaviour {
        ...
        // iOS 設定
        string IOS_BANNER_ID = "54ad6339d1126995";          // IOS バナーID
        string IOS_INTER_ID = "01e348abd420837b";           // IOS インタースティシャル広告ID
        string IOS_REWARD_ID = "5fcc6f36fdf8902e";          // IOS リワード広告ID

        // Android 設定 
        string ANDROID_BANNER_ID = "c43140b8130779b2";      // ANDROID バナーID
        string ANDROID_INTER_ID = "213b753e39aee853";       // ANDROID インタースティシャル広告ID
        string ANDROID_REWARD_ID = "efeebbf143486422";      // ANDROID リワード広告ID
