...
extern "C"
    ...
    void _MaxInitializeSdk(const char *serializedMetaData)
    {
        maybeInitializePlugin();
        
        _sdk = [_adManager initializeSdkWithMetaData: NSSTRING(serializedMetaData) andCompletionHandler:^(ALSdkConfiguration *configuration) {
