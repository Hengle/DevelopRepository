...
namespace SDKManager {
    public class AppLovinManager : MonoBehaviour {
        ...
        // iOS 設定
        string IOS_BANNER_ID = "1514be6dbab8fdf1";          // IOS バナーID
        string IOS_INTER_ID = "a405724e860abf6c";           // IOS インタースティシャル広告ID
        string IOS_REWARD_ID = "4ad7d84971620e1e";          // IOS リワード広告ID

        // Android 設定 
        string ANDROID_BANNER_ID = "2339a7a70a0e6cdb";      // ANDROID バナーID
        string ANDROID_INTER_ID = "22a4e778b147902c";       // ANDROID インタースティシャル広告ID
        string ANDROID_REWARD_ID = "b898ab4baa60ffb8";      // ANDROID リワード広告ID
